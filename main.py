...
def create_db(conn):  # создание таблиц
...
def add_client(conn, id, first_name, last_name, email, phone):    # добавление нового клиента
    with conn.cursor() as cur:
        cur.execute("""
...
def add_phone(conn, client_id, phone): # добавление телефона для существующего клиента
    with conn.cursor() as cur:
        cur.execute(""" 
...
def change_client(conn, client_id, first_name, last_name, email, phone): # изменить данные о клиенте
    with conn.cursor() as cur:
...
def delete_phone(conn, client_id, phone): # удалить телефон
    with conn.cursor() as cur:
...
def delete_client(conn, client_id):  # удалить клиента
    with conn.cursor() as cur:
...
def find_client(conn, first_name, last_name, email, phone):  # найти клиента
    with conn.cursor() as cur:
